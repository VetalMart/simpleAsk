    ...
    for i in xlsx_files_list:
        ...
        for j in wb_temp.sheetnames:
            if wb_temp[j]['A1'].value == "!!!":
                ...
                # строка
                raw_info = tuple_unzip(wb_temp[j]["A11":"AP11"])
                # фирма
                ...
                datalist[ask_number] = {
                    "raw_info": {
                        ...
                        "tu": raw_info[8],
                        "project": raw_info[9],
                        "diop_request": raw_info[10],
                        "diop_answer": raw_info[11],
                        "project_org": raw_info[12],
                        "aim": raw_info[13],
                        "gas_pipeline": {
                            "h_pressure": {
                                "rozp": {
...
for k, v in datalist.items():
    ...
    new_ws['K10'] = v['raw_info']['diop_request']
    new_ws['L10'] = v['raw_info']['diop_answer']
    new_ws['M10'] = v['raw_info']['project_org']
    new_ws['N10'] = v['raw_info']['aim']
    # short form of varyable
    vrg = v['raw_info']['gas_pipeline']
    new_ws['O10'] = vrg['h_pressure']['rozp']['d']['pe']
    new_ws['P10'] = vrg['h_pressure']['rozp']['d']['steel']
    new_ws['Q10'] = vrg['h_pressure']['rozp']['l']
    new_ws['R10'] = vrg['h_pressure']['vvid']['d']['pe']
    new_ws['S10'] = vrg['h_pressure']['vvid']['d']['steel']
    new_ws['T10'] = vrg['h_pressure']['vvid']['l']
    new_ws['U10'] = vrg['l_pressure']['rozp']['d']['pe']
    new_ws['V10'] = vrg['l_pressure']['rozp']['d']['steel']
    new_ws['W10'] = vrg['l_pressure']['rozp']['l']
    new_ws['X10'] = vrg['l_pressure']['vvid']['d']['pe']
    new_ws['Y10'] = vrg['l_pressure']['vvid']['d']['steel']
    new_ws['Z10'] = vrg['l_pressure']['vvid']['l']
    new_ws['AA10'] = vrg['l_pressure']['vvidnyi']['d']
    new_ws['AB10'] = vrg['l_pressure']['vvidnyi']['l']
    new_ws['AC10'] = v['raw_info']['regulator']['GRP']['type']
    new_ws['AD10'] = v['raw_info']['regulator']['GRP']['amount']
    new_ws['AE10'] = v['raw_info']['regulator']['RT']['type']
    new_ws['AF10'] = v['raw_info']['regulator']['RT']['amount']
    new_ws['AG10'] = v['raw_info']['gso']['aim']
    new_ws['AH10'] = v['raw_info']['gso']['info']
    new_ws['AI10'] = v['raw_info']['gso']['gas_consume']
    new_ws['AJ10'] = v['raw_info']['vog']['type']
    new_ws['AK10'] = v['raw_info']['vog']['model']
    new_ws['AL10'] = v['raw_info']['vog']['amount']
    new_ws['AM10'] = v['raw_info']['korretor']['model']
    new_ws['AN10'] = v['raw_info']['korretor']['amount']
    new_ws['AO10'] = v['raw_info']['building']['flat']
    new_ws['AP10'] = v['raw_info']['building']['level']

    new_ws.print_area = 'A1:AP16'
